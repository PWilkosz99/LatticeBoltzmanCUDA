#code based on https://github.com/gibiansky/experiments
...
# Initialize figure.
fig = plt.figure()
fig.canvas.manager.set_window_title('Lattice Boltzmann Method - Diffusion by Piotr Wilkosz')
...
def draw_fluid(vals, xlow, xhigh, ylow, yhigh):
    ...
    axis.imshow(vals, extent=(xlow, xhigh, ylow, yhigh),
                interpolation='bicubic', cmap=cm.Reds,
                vmin=0, vmax=20)
...
initialize()
anim = animation.FuncAnimation(fig, frame, interval=30, frames=100000000)
plt.show()
